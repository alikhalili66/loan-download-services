...
//        System.out.println(random_int);
	...
	public static boolean isOldNationalCard(String nationalNumberSerial) {
		if (nationalNumberSerial == null) {
			return false;
		}
		return pattern.matcher(nationalNumberSerial).matches();
	}
	
//	public static int otpGenerator() {
//		int code = generateRandomNumber();
//		return Integer.parseInt(String.valueOf(code)+VerhoeffCheckDigitAlgorithm.generateVerhoeff(String.valueOf(code)));
//		
//	}
