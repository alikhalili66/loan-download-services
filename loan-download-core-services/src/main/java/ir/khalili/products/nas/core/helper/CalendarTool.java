...
* -200100 (of both calendars) up to a few millions (10^6) years into the
...
* period since JDN=-34839655 (i.e. the year -200100 of both calendars) to
...
* the period since JDN=-34839655 (i.e. the year -200100 of both calendars) to
* some millions (10^6) years ahead of the present. The algorithm is based on
* D.A. Hatcher, Q.Jl.R.Astron.Soc. 25(1984), 53-55 slightly modified by K.M.
* Borkowski, Post.Astron. 25(1987), 275-279).
*/
